...
\newpage
\section[Analiza transferjev za pokojnine v Sloveniji in ostalih državah]{Analiza transferjev za pokojnine v Sloveniji in ostalih državah}
...
\caption{vir: [\ref{Pokojninski transferji v državah}]}
\label{Slika 4}
\end{figure}
...
\caption{vir: [\ref{BDP na prebivalca}]}
\label{Slika 6}
\end{figure}
